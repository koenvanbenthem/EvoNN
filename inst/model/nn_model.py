def bd_estimation(model_path, tree_nd, tree_el, tree_st, tree_bt, scale):
...
def ddd_estimation(model_path, tree_nd, tree_el, tree_st, tree_bt, scale):
    # Set global variables
...
def monte_carlo_dropout(model_path, tree_nd, tree_el, tree_st, tree_bt, scale):
    depth = 2
    # Create dataset from imported data
    current_dataset = create_dataset(tree_nd, tree_el, tree_st, tree_bt)
